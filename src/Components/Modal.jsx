...
const Modal = ({ setIsModal, selectedUser }) => {
    ...
    return (
        <div className='absolute right-0 top-0  text-white imgModal flex items-center justify-center'>
            <div className="w-11/12 bg-white h-4/5 p-1 flex text-black">

                <a href={selectedUser.urls.full} target='_blank' className="imgBox bg-slate-50 w-4/6 flex items-center justify-center">
                    <img src={selectedUser.urls.full} title='Click for full display' className='w-fit h-full' alt="" />
                </a>
                <div className="details w-2/6 flex flex-col justify-around">
